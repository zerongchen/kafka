...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_serverbuild_quality_m.sh $(date +'%Y%m%d')
...
HIVE_DB=cmcc2
HIVE_TB=hive_serverbuild_quality_m
...
FROM hive_serverbuild_quality_d
...
DB_TABLENAME=hive_serverbuild_quality_m
