...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_resource_biz_flow_m.sh $(date +'%Y%m%d')
...
HIVE_DB=cmcc2
HIVE_TB=hive_resource_biz_flow_m
...
DB_TABLENAME=report_resource_biz_flow_m
