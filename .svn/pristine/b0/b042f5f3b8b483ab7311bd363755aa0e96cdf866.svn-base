...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_carrier_quality_h.sh $(date +'%Y%m%d %H')
...
HIVE_DB=cmcc2
HIVE_TB=hive_carrier_quality_h
...
DB_TABLENAME=report_carrier_quality_h
DB_COLUMNS="R_STATTIME,ENDTIME,CREATE_TIME,BIZ_ID,CARRIER_ID,FLOW_UP,FLOW_DN,CONNECT_COUNT,SUCCESSCONNECT_COUNT,CONNECTTIMEOUT_COUNT,RESPFAIL_COUNT,RESPONSE_DELAY,CLIENT_DELAY,SERVER_DELAY,DATAPACKAGE_UP,DATAPACKAGE_DN,RETRANSPACKAGE_UP,RETRANSPACKAGE_DN,SESSIONTIME,MIDPACKAGEFLOW_DN,MIDPACKAGETIME_DN,BIGPACKAGEFLOW_DN,BIGPACKAGETIME_DN,TCP_SHAKEHANDS_TIME,TCP_CONNECT_COUNT"
