...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_protocol_flow_h.sh $(date +'%Y%m%d %H')
...
DB_TABLENAME=report_protocol_flow_h
DB_COLUMNS="R_STATTIME,ENDTIME,CREATE_TIME,PROTOFLAG,PROTOCOL_ID,FLOW_UP,FLOW_DN"
