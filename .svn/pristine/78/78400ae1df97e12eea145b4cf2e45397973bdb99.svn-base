...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_carrier_province_quality_m.sh $(date +'%Y%m%d')
...
HIVE_DB=cmcc2
HIVE_TB=hive_carrier_province_quality_m
...
FROM hive_carrier_province_quality_d
...
DB_TABLENAME=report_carrier_province_quality_m
