...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_resource_biz_flow_h.sh $(date +'%Y%m%d %H')
...
HIVE_DB=cmcc2
HIVE_TB=hive_resource_biz_flow_h
...
from hive_resource_biz_flow_min
...
DB_TABLENAME=report_resource_biz_flow_h
