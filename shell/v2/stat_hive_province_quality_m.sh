...
#10 00 * * * /home/hadoop/cmcc/hive/shell/stat_hive_province_quality_m.sh $(date +'%Y%m%d')
...
HIVE_DB=cmcc2
HIVE_TB=hive_province_quality_m
...
DB_TABLENAME=report_province_quality_m
